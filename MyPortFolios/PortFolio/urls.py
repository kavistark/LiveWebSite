...
urlpatterns = [
    ...
    path('folder_views/',views.folder_views,name='folder_views'),

    path('approve_file/<int:file_id>/', views.approve_file, name='approve_file'),
    path('decline_file/<int:file_id>/', views.decline_file, name='decline_file'),
    path('approved-files/', views.approved_files, name='approved_files'),
    path('approve_or_decline_file/<int:file_id>/', views.approve_or_decline_file, name='approve_or_decline_file'),
